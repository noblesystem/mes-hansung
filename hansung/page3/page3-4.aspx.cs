...
{
    public partial class page3_4 : System.Web.UI.Page
    {
        ...
        public string[] cl = new string[] { "orderdate", "salesrepresentative", "customercompany", "warehouse", "itemname", "standard", "qltincase", "qltcase", "issuedate", "remarks" };
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            mainData = cm.objOrder("where carship.codebill is null", employer, customer, litem);
        }
    }
}