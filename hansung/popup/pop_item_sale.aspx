<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pop_item_sale.aspx.cs" Inherits="hansung.popup.pop_item_sale" %>
<!DOCTYPE html>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#btnSelect').on('click', function () {
            ...
            var param = {};
            param = row[0];
            opener.pop_result_item_sale(param);
            window.close();
        });
        ...
        function fnSearch() {
            var param = JSON.stringify({ searchword : searchword, csaleno: csaleno });
            $.ajax({
                type: "POST",
                url: "/websvc_common.asmx/search_item_sale",
