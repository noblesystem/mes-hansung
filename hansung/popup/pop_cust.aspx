<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pop_cust.aspx.cs" Inherits="hansung.popup.pop_cust" %>
<!DOCTYPE html>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#btnSelect').on('click', function () {
            ...
            var param = {};
            param.custcd = row[0]["custcd"];
            param.custnm = row[0]["custnm"];
            param.tel = row[0]["tel"];
            opener.pop_result_cust(param);
            window.close();
        });
        ...
        function fnSearch() {
            ...
            $.ajax({
                type: "POST",
                url: "/websvc_common.asmx/search_cust",
