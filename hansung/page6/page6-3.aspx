<%@ Page Title="" Language="C#" MasterPageFile="~/Mtpage.Master" AutoEventWireup="true" CodeBehind="page6-3.aspx.cs" Inherits="hansung.page6.page6_3" %>
        ...
        <table id="table"  class="table1 table-striped table-bordered" style="width:100%">
            ...
            <thead>
                <tr>
                    ...
                    <th scope="col" style="text-align: center">불량처리형식
                    </th>
                    <th scope="col" style="text-align: center">불량처리 승인</th>
                    ...
                    <th scope="col" style="text-align: center">불량처리 항목비고
                    </th>
                </tr>
            </thead>
            ...
            <tbody>
               <%
                ...
                <!--
                <tr class="tr-total">
                    <td colspan="10" class="td-null">합계</td>
                     <td><%=sumbox %></td>
