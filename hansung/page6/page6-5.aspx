<%@ Page Title="" Language="C#" MasterPageFile="~/Mtpage.Master" AutoEventWireup="true" CodeBehind="page6-5.aspx.cs" Inherits="hansung.page6.page6_5" %>
        ...
        <table id="table"  class="table1 table-striped table-bordered" style="width:100%">
            ...
            <thead>
                <tr>
                    ...
                    <th scope="col" style="text-align: center">폐기 승인
                    </th>
                    ...
                    <th scope="col" style="text-align: center">불량 유형
                    </th>
