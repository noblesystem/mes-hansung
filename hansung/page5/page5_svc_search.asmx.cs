...
namespace hansung.page5 {
    ...
    public class page5_svc_search:System.Web.Services.WebService {

        [WebMethod]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public string page52_search(string param)
        {
