...
namespace hansung.page5 {
    ...
    public class page51_svc:System.Web.Services.WebService {
        ...
        public string detail_search(string param)
        {
            ...
            string query = @"PAGE51_DETAIL_SEARCH";
            dom.SelectSingleNode("//proc").InnerText = query;
            DataTable dt = CallDB.getExecuteDataTable(dom);
            return dt.ToJson();
        }
