...
{
    public partial class page2_6 : System.Web.UI.Page
    {
        ...
        public string[] clumn = new string[] { "ordernumber", "housename", "namewk", "namectm", "itemname", "standard", "quantityincase", "qltcase", "qltcase", "qltcase", "qltcontainer", "terms", "numbership", "duedate", "departuredate", "dateofarrival", "dateclearance", "conDuedate", "port", "nameshipname", "sizefit", "requestday", "remark" };
        protected void Page_Load(object sender, EventArgs e)
        {

            mainData = data.s_obj_2_4("where ship.confirmreceiptday is null");
